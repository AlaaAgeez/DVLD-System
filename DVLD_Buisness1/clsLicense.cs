...
namespace DVLD_Buisness1
{
    public class clsLicense
    {
        ...
        public bool IsDetained
        {
            get
            {
                return true/*clsDetainedLicense.IsLicenseDetained(this.LicenseID)*/;
            }
        }
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            return true/*this.DetainedInfo.ReleaseDetainedLicense(ReleasedByUserID,Application.ApplicationID)*/;
        }
